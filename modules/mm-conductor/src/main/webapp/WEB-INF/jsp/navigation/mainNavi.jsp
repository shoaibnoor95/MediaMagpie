...
<li class="dropdown<c:if test="${activeMenu == 'media'}"> active</c:if>"><a href="#" class="dropdown-toggle" data-toggle="dropdown"
...
<li class="dropdown<c:if test="${activeMenu == 'config'}"> active</c:if>"><a href="#" class="dropdown-toggle" data-toggle="dropdown"
	data-hover="dropdown">Configuration<b class="caret"></b></a> <core:ErrorHint requiredSetupTasks="${requiredSetupTasks}"
		mainItemName="config" />
	<ul class="dropdown-menu">
