...
public class FfmpegWrapper {
    ...
    public File convertVideo(File outputFile, VideoFormat destFormat, Integer width) {
        ...
        case WebM_vp8:
            ...
            // rwe: fast, but less quality: arguments.addAll(Arrays.asList("-vcodec", "libvpx", "-cpu-used", "-5", "-deadline", "realtime"));
        ...
        case OGG_Theora:
            ...
            //rwe: good result, but big file: arguments.addAll(Arrays.asList("-codec:v", "libtheora", "-qscale:v", "7", "-codec:a", "libvorbis", "-qscale:a", "5"));
            break;
        case MP4_h264:
